...
# {0} = user mention/name | Dots & emojis auto-generated in play.py
AYU_MESSAGES = [
...
# Auto-generate animation frames from single messages
AYU_EMOJIS = ["🎵", "🎧", "⚡", "🔥", "✨", "💕"]
AYU_DOTS = ["..", "....", "......", "........", "..........", "............"]
AYU = [[f"{msg}{AYU_DOTS[i]} {AYU_EMOJIS[i]}" for i in range(6)] for msg in AYU_MESSAGES]
