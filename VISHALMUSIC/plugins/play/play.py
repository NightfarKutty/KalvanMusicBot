...
from VISHALMUSIC.utils.decorators.play import PlayWrapper
from VISHALMUSIC.utils.errors import capture_err, capture_callback_err
from VISHALMUSIC.utils.formatters import formats
from VISHALMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
async def start_search_animation(mystic, frames):
    """Animate the searching message like start.py style - one shot fast animation."""
    try:
